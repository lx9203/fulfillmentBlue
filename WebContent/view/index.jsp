  		...
  		for(var i=0;i<kLogin;i++){
  			if(login.loginType[i].checked == true){
  				if(login.loginType[i].value == 1){
  	  				...
  	  				document.location.href = "deliver/deliverMain.jsp";
...
-->
<!--
                  <a href="user/blueCompany.jsp" class="btn btn-primary btn-user btn-block"></a>
-->
...
<!-- 비밀번호 찾기 or 초기화 요청
                <div class="text-center">
                  <a class="small" href="user/forgot-password.jsp">Forgot Password?</a>
                </div>
-->
                <div class="text-center">
